...
fn create_store_from_storage(storage: Arc<InMemoryStorage>) -> Arc<MarmosaStore<Arc<InMemoryStorage>, FakeClock>> {
    Arc::new(MarmosaStore::new(storage, FakeClock::new(100)))
}
